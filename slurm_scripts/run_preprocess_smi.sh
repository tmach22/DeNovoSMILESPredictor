...
#SBATCH --output=/bigdata/jianglab/shared/ExploreData/slurm_logs/run_preprocess_smi%j.out  # Standard output file
#SBATCH --error=/bigdata/jianglab/shared/ExploreData/slurm_logs/run_preprocess_smi%j.err   # Standard error file
...
python /bigdata/jianglab/shared/ExploreData/scripts/preprocess_smi.py
