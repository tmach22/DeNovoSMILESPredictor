...
#SBATCH --time=0-07:00:00             # Max job runtime: 30 minutes (adjust if needed)
#SBATCH --gres=gpu:1                  # Request 1 GPU of any type (e.g., gpu:a100:1 for a specific A100 GPU)
#SBATCH --output=/bigdata/jianglab/shared/ExploreData/slurm_logs/training_run_%j.out  # Standard output file
#SBATCH --error=/bigdata/jianglab/shared/ExploreData/slurm_logs/training_run_%j.err   # Standard error file
...
python /bigdata/jianglab/shared/ExploreData/scripts/train.py
